...
public class Gato extends Animal{
	...
	public Gato(int edad, double peso, String raza, String sexo, String nombre,
			boolean obesidad) {
	...
	public String toString() {
		return "Gato [obesidad=" + obesidad + ", nombre=" + nombre + ", raza=" + raza + ", sexo=" + sexo + ", edad="
				+ edad + ", peso=" + peso + ", libroVacunacion=" + libroVacunacion + "]";
	}
